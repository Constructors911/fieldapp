...
- GET|POST /api/cron/clock-out-reminders -> { sent, skipped? } (Vercel cron / `x-cron-secret` or `Authorization: Bearer CRON_SECRET`; emails 8/12/16h open clocks when Resend is configured)
